...
ти його вже не побачиш. У reply не описуй фото, а підтверди, що записав. Без підпису або \
коли з підпису не ясно, що зробити, — нічого не записуй: скажи в одному реченні, що бачиш, \
і спитай, що з цим зробити.
