...
бути самодостатнім: фото лишається на вебі під річчю чи нотаткою, але в наступних \
повідомленнях ти його вже не побачиш. У reply не описуй фото, а підтверди, що записав. \
