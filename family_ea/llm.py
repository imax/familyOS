...
- today — список на сьогодні: у кожного своя дошка дрібних справ на день, видно обом. \
...
повний новий текст списку одним граматичним реченням: справи через кому, «і» перед \
